...
⚠️ This package is **abandoned** and no longer maintained. The author suggests using the **[rinvex/laravel-addresses](https://github.com/rinvex/laravel-addresses)** package instead. ⚠️
